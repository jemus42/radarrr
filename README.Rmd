...
<!-- badges: start -->
[![R build status](https://github.com/jemus42/radarrr/workflows/R-CMD-check/badge.svg)](https://github.com/jemus42/radarrr/actions)
...
The goal of `radarrr` is to get movies out of [Radarr](https://github.com/Radarr/Radarr). The API is [documented here](https://github.com/Radarr/Radarr/wiki/API).
